...
actor {
  ...
  // ATTENDANCE - No IC identity check, open to all callers
  ...
  // HALF DAY RECORDS - Password-only auth
  ...
  // STAFF PASSWORD MANAGEMENT - Password-only auth
